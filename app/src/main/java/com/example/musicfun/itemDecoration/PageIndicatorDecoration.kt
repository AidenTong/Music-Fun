...
class PageIndicatorDecoration(private val itemCount: Int) : ItemDecoration() {
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        Log.d(" adasdasdas ", (progress.toString()))
        if(!(activePosition % itemCount == itemCount - 1 && progress > 0.0)) {
